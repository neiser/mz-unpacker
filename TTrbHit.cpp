...
void TTrbHit::Set(UInt_t nUserTrbAddress, UInt_t nUserTdcChannel, UInt_t nUserSubEvtId, UInt_t nUserTdcErrCode, UInt_t nUserEdge, UInt_t nUserCoarseTime, UInt_t nUserFineTime, Bool_t bUserIsRefChannel){
