void BuildTrbCalibration(){
	...
	cout << "Building TRB Fine Time class ..." << endl;
	gROOT->ProcessLine(".L TTrbFineTime.cpp+");
	cout << "Building TRB Calibration ..." << endl;
	gROOT->ProcessLine(".L TTrbCalibration.cpp+");
}
